    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        else
        {
                try
                    {
                        connect();
                        query="select * from books where bid='"+t3.getText()+"';";
                        ...
                        if(t6.getText().equals("YES"))
                        {
                            ...
                            int bid=Integer.parseInt(t3.getText());
                            String myquery="insert into issue(StudentId,StudentName,bid,Available,bname,issue_date,SStream,SClass,Address) values(?, ?, ?, ?,?,?,?,?,?) ";
...
//                            stmt.executeUpdate(query);
    ...
    public void connect()
    {
        ...
        {  
            ...
            con=DriverManager.getConnection(url,Admin_name,Admin_pass);
